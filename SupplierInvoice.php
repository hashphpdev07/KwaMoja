...
echo '<p class="page_title_text">
		<img alt="" src="', $RootPath, '/css/', $_SESSION['Theme'], '/images/transactions.png" title="', _('Supplier Invoice'), '" />', ' ', _('Enter Supplier Invoice'), ': ', $SupplierName, ' ', $_SESSION['SuppTrans']->SupplierID, '
	</p>';
