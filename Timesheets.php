				...
				if ($_SESSION['CompanyRecord']['gllink_stock'] == 1 and ($WeekTimeRow['labourcost'] * $WeekTimeRow['totalweekhours']) != 0) {
					...
					$SQL = "INSERT INTO gltrans (type,
							...
							VALUES (28,
								...
								'" . _('WO') . ':' . $WeekTimeRow['wo'] . ' ' . $WeekTimeRow['firstname'] . ' ' . $WeekTimeRow['lastname'] . ' ' . _('as') . ' ' . $WeekTimeRow['issueitem'] . ' x ' . $WeekTimeRow['totalweekhours'] . ' ' . _('hours') . ' @ ' . locale_number_format($WeekTimeRow['labourcost'], $_SESSION['CompanyRecord']['decimalplaces']) . "',
