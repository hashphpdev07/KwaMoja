...
echo '<p class="page_title_text">
		<img class="page_title_icon" alt="" src="', $RootPath, '/css/', $_SESSION['Theme'], '/images/user.png" title="', _('Timesheets'), '" /> ', _('Timesheet Entry'), '
	</p>'; // Page title.
		...
		if (DB_num_rows($CheckTimesheetResult) == 1) {
			...
			$InsertTimsheetResult = DB_query("INSERT INTO timesheets (wo,
													...
													VALUES ('" . $_POST['WO'] . "',
															...
															'" . $_POST['Day5'] . "',
															'" . $_POST['Day6'] . "',
															'" . $_POST['Day7'] . "')", _('Could not add this timesheet record'));
...
if (!isset($SelectedEmployee)) {
	...
	$SQL = "SELECT prlemployeemaster.employeeid,
					...
					prlemployeemaster.manager,
					prlemployeemaster2.firstname as managerfirstname,
					prlemployeemaster2.lastname as managersurname,
					prlemployeemaster.normalhours,
					prlemployeemaster.email1,
					prlemployeemaster.userid
			FROM prlemployeemaster LEFT JOIN prlemployeemaster AS prlemployeemaster2
			ON prlemployeemaster.manager=prlemployeemaster2.employeeid";
	$Result = DB_query($SQL);
...
if (isset($SelectedEmployee)) {
	...
	echo '<fieldset>';
	echo '<legend>', _('For'), ' ', $EmployeeRow['firstname'], ' ', $EmployeeRow['lastname'], ' ', _('for the week ending'), ': <select name="WeekEnding" onChange="ReloadForm(TimesheetForm.RefreshWeek)" >';
	...
	echo '</select>
		<input type="submit" name="RefreshWeek" value="Refresh" />
	</legend>';
	...
	if (isset($_POST['WeekEnding'])) {
			...
			while ($TimesheetRow = DB_fetch_array($TimesheetResult)) {
				if ($TimesheetRow['status'] == 2) { //the timesheet is already posted - no changes are now possible
					...
					echo '<tr class="striped_row">
							...
							<td>', $TimesheetRow['workcentrename'], '</td>
							<td class="number"><input type="text" required="required" class="number" name="Day1_', $RowNo, '" value="', $TimesheetRow['day1'], '" minlength="1" maxlength="2" size="3" /></td>
							<td class="number"><input type="text" required="required" class="number" name="Day2_', $RowNo, '" value="', $TimesheetRow['day2'], '" minlength="1" maxlength="2" size="3" /></td>
							<td class="number"><input type="text" required="required" class="number" name="Day3_', $RowNo, '" value="', $TimesheetRow['day3'], '" minlength="1" maxlength="2" size="3" /></td>
							<td class="number"><input type="text" required="required" class="number" name="Day4_', $RowNo, '" value="', $TimesheetRow['day4'], '" minlength="1" maxlength="2" size="3" /></td>
							<td class="number"><input type="text" required="required" class="number" name="Day5_', $RowNo, '" value="', $TimesheetRow['day5'], '" minlength="1" maxlength="2" size="3" /></td>
							<td class="number"><input type="text" required="required" class="number" name="Day6_', $RowNo, '" value="', $TimesheetRow['day6'], '" minlength="1" maxlength="2" size="3" /></td>
							<td class="number"><input type="text" required="required" class="number" name="Day7_', $RowNo, '" value="', $TimesheetRow['day7'], '" minlength="1" maxlength="2" size="3" /></td>
							...
							<td><a href="', htmlspecialchars($_SERVER['PHP_SELF'] . '?Delete=' . urlencode($TimesheetRow['id']) . '&SelectedEmployee=' . urlencode($SelectedEmployee) . '&WeekEnding=' . urlencode($_POST['WeekEnding']), ENT_QUOTES, 'UTF-8'), '" onclick="return confirm(\'', _('Are you sure you wish to delete this timesheet entry'), '\');">', _('Delete'), '</a></td>
						</tr>';
				}
		...
		echo '</select>
			...
			<td class="number"><input type="text" required="required" class="number" name="Day1" value="', $_POST['Day1'], '" minlength="1" maxlength="2" size="3" /></td>
			<td class="number"><input type="text" required="required" class="number" name="Day2" value="', $_POST['Day2'], '" minlength="1" maxlength="2" size="3" /></td>
			<td class="number"><input type="text" required="required" class="number" name="Day3" value="', $_POST['Day3'], '" minlength="1" maxlength="2" size="3" /></td>
			<td class="number"><input type="text" required="required" class="number" name="Day4" value="', $_POST['Day4'], '" minlength="1" maxlength="2" size="3" /></td>
			<td class="number"><input type="text" required="required" class="number" name="Day5" value="', $_POST['Day5'], '" minlength="1" maxlength="2" size="3" /></td>
			<td class="number"><input type="text" required="required" class="number" name="Day6" value="', $_POST['Day6'], '" minlength="1" maxlength="2" size="3" /></td>
			<td class="number"><input type="text" required="required" class="number" name="Day7" value="', $_POST['Day7'], '" minlength="1" maxlength="2" size="3" /></td>
		</tr>';
	...
	if (isset($SelectedEmployee) and $RowNo > 0) { //a timesheet administrator
		echo '<br />
