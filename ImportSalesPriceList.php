...
echo '<p class="page_title_text">
		<img alt="" src="', $RootPath, '/css/', $_SESSION['Theme'], '/images/maintenance.png" title="', _('Import Price List from CSV file'), '" />', ' ', _('Import Price List from CSV file'), '
	</p>';
...
if (isset($_FILES['PriceListFile']) and $_FILES['PriceListFile']['name']) { //start file processing
	...
	echo '<fieldset>
			...
			<field>
				<label for="PriceListFile">', _('Upload file'), ':</label>
