...
echo '<html>
		<head>
			...
			<link rel="icon" href="', $PathPrefix, $RootPath, '/favicon.ico" />
			<link href="', $PathPrefix, $RootPath, '/css/', $_SESSION['Theme'], '/styles.css?v=13" rel="stylesheet" type="text/css" media="screen" />
