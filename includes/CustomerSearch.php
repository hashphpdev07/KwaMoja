...
function ShowCustomerSearchFields($rootpath, $theme) {
...
function ShowReturnedCustomers($result) {
	...
	if ($_SESSION['ListPageMax'] > 1) {
		echo '<div class="centre">&nbsp;&nbsp;' . $_POST['PageOffset'] . ' ' . _('of') . ' ' . $_SESSION['ListPageMax'] . ' ' . _('pages') . '. ' . _('Go to Page') . ': ';
