...
echo '<p class="page_title_text">
		<img src="', $RootPath, '/css/', $_SESSION['Theme'], '/images/maintenance.png" title="', _('Shop Configuration'), '" alt="" />', $Title, '
	</p>';
...
echo '<field>
		...
		<input type="email" name="X_ShopManagerEmail" required="required" size="50" maxlength="50" value="', $_SESSION['ShopManagerEmail'], '" />
...
echo '<field>
		...
		<input type="text" size="12" maxlength="10" required="required" name="X_ShopBranchCode" value="', $_SESSION['ShopBranchCode'], '" />
...
echo '<field>
		...
		<textarea name="X_ShopPrivacyStatement" rows="8" cols="100">', stripslashes($_SESSION['ShopPrivacyStatement']), '</textarea>
...
echo '<field>
		...
		<textarea name="X_ShopTermsConditions" rows="8" cols="100">', stripslashes($_SESSION['ShopTermsConditions']), '</textarea>
...
echo '<field>
		...
		<textarea name="X_ShopAboutUs" rows="8" cols="100">', stripslashes($_SESSION['ShopAboutUs']), '</textarea>
...
echo '<field>
		...
		<textarea name="X_ShopContactUs" rows="8" cols="100">', stripslashes($_SESSION['ShopContactUs']), '</textarea>
...
echo '<field>
		...
		<textarea name="X_ShopFreightPolicy" rows="8" cols="100">', stripslashes($_SESSION['ShopFreightPolicy']), '</textarea>
...
echo '</select>
	<fieldhelp>', _('Shows only items with QOH greater than zero thus avoiding the Arriving Soon items.'), '</fieldhelp>
</field>';
...
echo '</select>
	<fieldhelp>', _('Select the service item to use for payment surcharges to be processed as'), '</fieldhelp>
</field>';
...
echo '</select>
	<fieldhelp>', _('Select the bank account to use for receipts processed by Pay Pal'), '</fieldhelp>
</field>';
...
echo '</select>
	<fieldhelp>', _('Select the P/L account to use for commissions (transaction fees) charged by Pay Pal'), '</fieldhelp>
</field>';

echo '<field>
		<label for="X_ShopPayPalSurcharge">', _('PayPal Surcharge'), ':</label>
		<input type="text" class="number" size="5" maxlength="5" name="X_ShopPayPalSurcharge" value="', $_SESSION['ShopPayPalSurcharge'], '" /></td>
		<fieldhelp>', _('The PayPal surcharge'), '</fieldhelp>
	</field>';

if ($AllowDemoMode) {
	echo '<field>
			<label>', _('Paypal user account details'), '</td>
			<div class="fieldtext">', _('Cannot be set in the demo'), '</div>
		</field>';
} else {
	echo '<field>
			<label for="X_ShopPayPalUser">', _('PayPal User'), ':</label>
			<input type="text" class="noSpecialChars" size="40" maxlength="40" name="X_ShopPayPalUser" value="', $_SESSION['ShopPayPalUser'], '" /></td>
	...
	echo '<field>
			...
			<input type="text" size="20" maxlength="20" name="X_ShopPayPalPassword" value="', $_SESSION['ShopPayPalPassword'], '" /></td>
	...
	echo '<field>
			...
			<input type="text" size="80" maxlength="100" name="X_ShopPayPalSignature" value="', $_SESSION['ShopPayPalSignature'], '" /></td>
...
echo '</select>
	<fieldhelp>', _('Select the bank account to use for receipts processed by credit card'), '</fieldhelp>
</field>';
