...
if (isset($Patient)) {
	...
	if (isset($_SESSION['Care2xDatabase']) and $_SESSION['Care2xDatabase'] != 'None' and $_SESSION['Items']['Lines'] == 0) {
		$Care2xSQL = "SELECT " . $_SESSION['Care2xDatabase'] . ".care_encounter_prescription_sub.bestellnum,
							" . $_SESSION['Care2xDatabase'] . ".care_encounter_prescription_sub.prescription_nr,
							partcode,
							dosage,
							prescribe_date
						FROM " . $_SESSION['Care2xDatabase'] . ".care_encounter_prescription_sub
						LEFT JOIN " . $_SESSION['Care2xDatabase'] . ".care_pharma_products_main
						ON " . $_SESSION['Care2xDatabase'] . ".care_encounter_prescription_sub.bestellnum=" . $_SESSION['Care2xDatabase'] . ".care_pharma_products_main.item_id
						LEFT JOIN stockmaster
						ON " . $_SESSION['Care2xDatabase'] . ".care_pharma_products_main.partcode=stockmaster.stockid
