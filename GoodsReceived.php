...
echo '<p class="page_title_text">
		<img src="', $RootPath, '/css/', $_SESSION['Theme'], '/images/supplier.png" title="', _('Receive'), '" alt="" />', _('Receive Purchase Order'), ' : ', $_SESSION['PO' . $Identifier]->OrderNo, ' ', _('from'), ' ', $_SESSION['PO' . $Identifier]->SupplierName, ' ', _('into'), ' ', $LocationName, '
	</p>';
...
if (!isset($_POST['ProcessGoodsReceived'])) {
	...
	echo '<table>
			<tr>
				...
				<td><input type="text" class="date" size="10" name="DefaultReceivedDate" value="', $_SESSION['PO' . $Identifier]->DefaultReceivedDate, '" /></td>
	...
	echo '<table cellpadding="2">
			<tr>
				<th colspan="2"></th>
				<th align="center" colspan="4"><b>', _('Supplier Units'), '</b></th>
				<th></th>
...
if (count($_SESSION['PO' . $Identifier]->LineItems) > 0 and !isset($_POST['ProcessGoodsReceived'])) {
	...
	if ($_SESSION['ShowValueOnGRN'] == 1) {
		echo '<tr>
				<td colspan="14" class="number"><b>', _('Total value of goods received'), '</b></td>
