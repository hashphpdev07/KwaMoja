...
InsertRecord('care_type_encounter', array('type_nr'), array(1), array('type_nr', 'type', 'name', 'LD_var', 'description', 'hide_from', 'status', 'history', 'modify_id', 'modify_time', 'create_id', 'create_time'), array(1, 'referral', 'Referral', 'LDEncounterReferral', 'Referral admission or visit', 0, '0', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00'));
InsertRecord('care_type_encounter', array('type_nr'), array(2), array('type_nr', 'type', 'name', 'LD_var', 'description', 'hide_from', 'status', 'history', 'modify_id', 'modify_time', 'create_id', 'create_time'), array(2, 'emergency', 'Emergency', 'LDEmergency', 'Emergency admission or visit', 0, '0', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00'));
InsertRecord('care_type_encounter', array('type_nr'), array(3), array('type_nr', 'type', 'name', 'LD_var', 'description', 'hide_from', 'status', 'history', 'modify_id', 'modify_time', 'create_id', 'create_time'), array(3, 'birth_delivery', 'Birth delivery', 'LDBirthDelivery', 'Admission or visit for birth delivery', 0, '0', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00'));
InsertRecord('care_type_encounter', array('type_nr'), array(4), array('type_nr', 'type', 'name', 'LD_var', 'description', 'hide_from', 'status', 'history', 'modify_id', 'modify_time', 'create_id', 'create_time'), array(4, 'walk_in', 'Walk-in', 'LDWalkIn', 'Walk -in admission or visit (non-referred)', 0, '0', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00'));
InsertRecord('care_type_encounter', array('type_nr'), array(5), array('type_nr', 'type', 'name', 'LD_var', 'description', 'hide_from', 'status', 'history', 'modify_id', 'modify_time', 'create_id', 'create_time'), array(5, 'accident', 'Accident', 'LDAccident', 'Emergency admission due to accident', 0, '0', '', '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00'));
