...
if (isset($_GET['SerialNo'])) {
	...
	echo '<div class="centre">', _('New Serial Number'), '<input type="text" name="NewSerialNo" value="', $_GET['SerialNo'], '" />
...
if (isset($_POST['SubmitItemCode'])) {
	...
	while ($MyRow = DB_fetch_array($Result)) {
		echo '<tr>
				...
				<td><a href="' . htmlspecialchars(basename(__FILE__), ENT_QUOTES, 'UTF-8') . '?SerialNo=', $MyRow['serialno'], '&StockID=', $_POST['StockCode'], '">', _('Change'), '</a></td>
			</tr>';
	}
	echo '</tbody>
		</table>';
