...
if ($_SESSION['Project' . $Identifier]->Status == 2) { //the project is an order being processed now
	echo '<form  method="post" action="' . htmlspecialchars(basename(__FILE__), ENT_QUOTES, 'UTF-8') . '?SelectedProject=' . $_SESSION['Project' . $Identifier]->ProjectRef . '&amp;identifier=' . $Identifier . '">';
