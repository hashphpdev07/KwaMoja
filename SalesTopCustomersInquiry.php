...
echo '<p class="page_title_text">
		<img src="', $RootPath, '/css/', $_SESSION['Theme'], '/images/transactions.png" title="', _('Sales Inquiry'), '" alt="" />', ' ', _('Top Customer Sales Inquiry'), '
	</p>';
...
echo '<field>
		<label for="Custom">', _('Custom Range'), ':</label>
